...
from app.qc.schema import ensure_qc_schema, ensure_inspection_results_schema

init_db()
ensure_template_schema()
ensure_qc_schema()
ensure_inspection_results_schema()
...
if is_local_environment():
    ...
    from .app_routes.calibration_routes import calibration_blueprint
    ...
    register_blueprint_with_v1_alias(calibration_blueprint, "calibration_blueprint")
