...
class LocalLLMProcessor(ContextAwareProcessor):
    processor_type = ProcessorType.LOCAL_LLM
    ...
    def process(self):
        ...
        context = self.get_input_by_name("context", self.context)
        ...
        data = post_json("/llm", payload, self.endpoint_url)
